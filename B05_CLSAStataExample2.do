/* Change working directory for importing data*/
cd "[Path to source file]" 

drop _all
import delimited CLSASmallExample.csv , case(preserve) 

/* Change working directory for saving results*/
cd "[Path to source file]\EstimationResults\Stata"
